...
void vector_apply(VECTOR output, const VECTOR input0, const MATRIX input1) {
  output[_X] = input0[_X] * input1[_11] + input0[_Y] * input1[_12]
               + input0[_Z] * input1[_13] + input0[_W] * input1[_14];
  output[_Y] = input0[_X] * input1[_21] + input0[_Y] * input1[_22]
               + input0[_Z] * input1[_23] + input0[_W] * input1[_24];
  output[_Z] = input0[_X] * input1[_31] + input0[_Y] * input1[_32]
               + input0[_Z] * input1[_33] + input0[_W] * input1[_34];
  output[_W] = input0[_X] * input1[_41] + input0[_Y] * input1[_42]
...
void vector_normalize(VECTOR vector) {
  ...
  k = 1.0f
      / sqrtf(vector[_X] * vector[_X] + vector[_Y] * vector[_Y] + vector[_Z] * vector[_Z]);
  vector[_X] *= k;
  vector[_Y] *= k;
  vector[_Z] *= k;
}
...
void vector_normalize_into(VECTOR output, const VECTOR input0) {
  ...
  k = 1.0f
      / sqrtf(input0[_X] * input0[_X] + input0[_Y] * input0[_Y] + input0[_Z] * input0[_Z]);
